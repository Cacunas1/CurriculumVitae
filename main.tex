...
\address{El Nogal 2659}{Viña del Mar, Región de Valparaíso}{Chile}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
%\phone[móbil]{+56~9~6403~7058}                   % optional, remove / comment the line if not wanted
%\phone[fixed]{+2~(345)~678~901}                    % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
\email{c.acuna.sepulveda@gmail.com}                               % optional, remove / comment the line if not wanted
...
\section{Educación}
\cventry{2017}{Licenciatura en Ciencias de la Ingeniería Electrónica}{UTFSM}{Valparaíso}{}{}  % arguments 3 to 6 can be left empty
\cventry{2017}{Egresado Ingeniería Ejecución en Electrónica}{UTFSM}{Valparaíso}{}{Mención Computadores}
...
\begin{cvcolumns}
  ...
  \cvcolumn{Category 2}{Amongst others:
    \begin{itemize}
        \item Person 1, and
        \item Person 2
    \end{itemize}
...
mattis. Donec sapien nulla, feugiat eget adipiscing sit amet, lacinia ut dolor.
Phasellus tincidunt, leo a fringilla consectetur, felis diam aliquam urna, vitae
aliquet lectus orci nec velit. Vivamus dapibus varius blandit.
